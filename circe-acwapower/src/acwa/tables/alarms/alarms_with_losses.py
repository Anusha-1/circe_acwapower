"""
acwa.tables.alarms_with_losses

Validation schema for alarms_with_losses table
"""
...
class AlarmsLossesSchema(pa.DataFrameModel):
    """Schema for table alarms_with_losses"""
