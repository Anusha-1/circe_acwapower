"""
acwa.alarms.aggregate.component

Module to aggregate alarms (durationa and losses) by component
"""
...
def aggregate_component_per_day(
        df_oper_10min: pd.DataFrame, 
        df_alarms: pd.DataFrame) -> pd.DataFrame:
    """
    Aggregate alarms (durationa and losses) by component daily

    NOTE: We have copy and change the logic developed to allocate manufacturer 
